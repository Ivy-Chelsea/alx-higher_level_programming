...
class TestSquare(unittest.TestCase):
    ...
    def test_10_3(self):
        """Test Square class: checks for missing args"""
    ...
    def test_11_0(self):
        """Test Square class: checks for size attribute"""
    ...
    def test_11_1(self):
        """Test Square class: checks for wrong attributes"""
    ...
    def test_14_0(self):
        """Test for public method to_dixtionary"""
    ...
    def test_14_1(self):
        ...
        s = "to_dictionary() takes 1 1positional argument but 2 were given"
        with self.assertRaises(TypeError) as x:
            s1 = Square(10, 2, 1, 9)
            s1_dictionary = s1.to_dictionary("Hi")
        self.assertEquals(s, str(x.exception))
